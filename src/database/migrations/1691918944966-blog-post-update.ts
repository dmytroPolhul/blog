...
export class BlogPostUpdate1691918944966 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "blog_post" ADD "isPublish" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "blog_post" ADD "tags" character varying array`);
    }
